#!/usr/bin/env python3
"""
bib2yaml.py -- turn material/uvilla.bib into _data/publications.yml
...
DEFAULT_BIB = os.path.join(ROOT, "material", "uvilla.bib")
...
def emit_yaml(records, path):
    lines = [
        "# Generated by scripts/bib2yaml.py from material/uvilla.bib",
        "# Do not edit by hand -- edit material/uvilla.bib and re-run:",
